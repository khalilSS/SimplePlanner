...
import com.example.simpleplanner.fragments.assignment;
import com.example.simpleplanner.fragments.calendar;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_assignment:
                        Toast.makeText(TodoActivity.this,"works",Toast.LENGTH_SHORT).show();
